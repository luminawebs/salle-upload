  ...
  return (
    <div className="flex space-x-1 bg-background p-1 rounded-lg border border-border">
      ...
      <button
        ...
        className={`px-4 py-1.5 text-sm font-medium rounded-md transition-all ${activeTab === 'unified' ? 'bg-primary text-white shadow' : 'text-gray-400 hover:text-white hover:bg-surface'}`}
      >
        Analizador (Test)
      </button>
    </div>
